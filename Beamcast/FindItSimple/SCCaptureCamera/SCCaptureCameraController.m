...
- (void)viewDidLoad
{
    ...
    [self addTopViewWithText:@"TAKE A PHOTO"];
...
- (void)addTopViewWithText:(NSString*)text {
    if (!_topContainerView) {
        ...
        UILabel *lbl = [[UILabel alloc] initWithFrame:topFrame];
        lbl.backgroundColor = [UIColor clearColor];
        lbl.textColor = [UIColor whiteColor];
        lbl.font = [UIFont fontWithName:FISFONT_SEMIBOLD size:20];
...
- (void)addMenuViewButtons {
    NSMutableArray *normalArr = [[NSMutableArray alloc] initWithObjects:@"icon_navigation_close", @"camera_line.png", @"switch_camera.png", @"flashing_off.png", nil];
